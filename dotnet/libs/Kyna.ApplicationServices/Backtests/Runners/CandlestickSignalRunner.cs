...
//        var chart = ChartFactory.Create(item.Code, configuration.Source,item.Industry, item.Sector,
//            ohlc, configuration.ChartConfiguration);

//        Debug.Assert(!string.IsNullOrWhiteSpace(chart.Info.Code));

//        _memoryCache.Set(chart.Info.Code, ohlc, new MemoryCacheEntryOptions()
//        {
